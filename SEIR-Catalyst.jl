...
# ╔═╡ cbc0b9cc-6cb5-11ec-1e4b-1910cf7e4e44
using Catalyst, Plots

# ╔═╡ 9f31363c-0f0e-4c39-857f-322272bad103
using DifferentialEquations

# ╔═╡ 3da7bd62-a5f7-433c-b1e8-e92f61998f4f
md"""
# SEIR model using Catalyst.jl
References:
- [Catalyst.jl](https://github.com/SciML/Catalyst.jl)
- [Modeling COVID 19 with Differential Equations](https://julia.quantecon.org/continuous_time/seir_model.html)
"""

# ╔═╡ cd63d3c0-bfab-451a-8729-62ed98d1928d
md"## Model parameters"

# ╔═╡ 35639c5c-bd33-44d9-8b5b-a69f632ca522
γ = 1/18

# ╔═╡ 511f7cad-1244-42c2-9c8f-e9547777d7d2
R₀ = 3.0

# ╔═╡ 6d3dc4d6-a972-4e84-ab62-e2506bd5c8e7
σ = 1/5.2

# ╔═╡ a5ef4d1c-cf6d-4ea4-b700-afe6b144e6b6
...
# ╔═╡ 079e6836-867f-4f8c-8e73-f540b9b94dca
tspan = (0.0,350.0)

# ╔═╡ 27798950-0226-4d52-9968-39d9af450cae
u0 = [1,1e-7,0,0] # order: SIER (because of how the equations are defined)

# ╔═╡ b4412086-951a-4bd2-af17-a97d88edcee5
p = [γ*R₀,σ,γ]

# ╔═╡ 7c104739-de11-4789-8c70-ed3ef25a7aa8
J = ODEProblem(seir, species(seir) .=> u0, tspan, parameters(seir) .=> p)

# ╔═╡ 2f6b3210-34a5-4f47-9b6c-335ac99616c5
sol = solve(J)

# ╔═╡ 3de5d418-7860-482c-b1cc-36e246ae0205
plot(sol,lw=2)
